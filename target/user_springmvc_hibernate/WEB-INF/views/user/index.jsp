...
<div class="main">
    <div>
        ...
        <input type="button" value="新增用户" id="adduserbutton"/>
        <br>
        <br>
...
<script type="text/javascript">
            ...
            if (username == "") {
                ...
                $.ajax({
                    ...
                    success: function (json) {
                        ...
                        if (json.check) {
                            window.location.href = "<%=basePath%>user/toquerpage?username=" + username;
                        } else {
                            alert('未查询到任何与输入用户名有关的信息！');
                        }
    ...
    $('#getexcel').click(function () {
        ...
        window.location.href = "<%=basePath%>user/getexcel?pageNo=" + pageNo;
    ...
    $('#adduserbutton').click(function(){
        window.location.href="<%=basePath%>add/toaddpage";
    })
    ...
    $('#checkremove').click(function () {
        ...
        if (idarrays == 0) {
            ...
            if (confirm("确定删除所选用户？")) {
                $.ajax({
                    type: "POST",
                    url: "<%=basePath%>user/removesomeuser",
                    data: {
                        ids: idarrays,
                        pageNo:${startPage},
                    },
